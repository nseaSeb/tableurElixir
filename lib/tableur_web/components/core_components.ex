defmodule TableurWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TableurWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TableurWeb.Gettext, "errors", msg, opts)
    end
  end
